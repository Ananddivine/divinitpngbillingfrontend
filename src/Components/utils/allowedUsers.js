...
// Import fixed user images
import AnandImage from "../../assets/profiles/anand.jpg";


// Mapping allowed users to their images
export const userProfileImages = {
  Anand: AnandImage,

};

// Mapping emails to profile names
export const profileData = {
  "anand@Divineit.com": { name: "Anand" },
};

// List of allowed users
export const allowedUsers = ["Anand", "Divine", "AmalRaj", "David"];

// Function to get user image
export const getUserImage = (userName) => {
  return allowedUsers.includes(userName) ? userProfileImages[userName] : defaultAvatar;
};

// Function to check if a user is allowed
export const isUserAllowed = (userName) => allowedUsers.includes(userName);
